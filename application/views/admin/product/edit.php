		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Thêm số lượng</label>
						<div class="col-sm-5">
							<input type="text" name='amount' class="form-control" id="inputEmail3" placeholder="" value="<?php echo number_format($product->amount); ?>">
						</div>
					</div>
					<div class="form-group">
