			...
			<div class="panel-body">
				<form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="number" name='price' class="form-control" id="inputEmail3" placeholder="" value="<?php echo set_value('price'); ?>">
						</div>
						<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="number" name='discount' class="form-control" id="inputEmail3" placeholder="" value="<?php echo set_value('discount'); ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Số lượng</label>
						<div class="col-sm-5">
							<input type="number" name='amount' class="form-control" id="inputEmail3" placeholder="" value="<?php echo set_value('amount'); ?>">
						</div>
					</div>
					<div class="form-group">
